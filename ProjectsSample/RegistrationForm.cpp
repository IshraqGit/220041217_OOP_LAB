...
registration(Login log){
    ...
    ofstream outfile("D:/IUT/IUT CSE/Batch - 22/3rd Semester/OOP/PROJECT/Sample/Login.txt",ios::app);
    if(!outfile){
...
ifstream infile("D:/IUT/IUT CSE/Batch - 22/3rd Semester/OOP/PROJECT/Sample/Login.txt");
if(!infile){
    cout<<"\tError: File Can't Open!"<< endl;
}else{
    string line;
